<template>
    <div class="container">
        <div class="mt-2 ps-2 pt-2" @click="back">
            <font-awesome-icon icon="fa-solid fa-arrow-left" class="me-2" />
            <span class="fw-bold">Back to home</span>
        </div>
        <h5 class="fw-bold mt-4 mb-3 col-10" style="font-size:16px">My orders</h5>
        <div class="row flex justify-center">
            <div class="col-12">
                <table class="table table-striped border" style="font-size:10px">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Order Code</th>
                    ...
                    <tbody>
                        <tr v-for="order, index in orders" :key="order">
                            ...
                            <template>
                                <div>
                                    <v-dialog v-model="showDialogArray[index]">
                                        <v-card width="100%" class="px-4 py-3 inconsolata">
                                            <div>
