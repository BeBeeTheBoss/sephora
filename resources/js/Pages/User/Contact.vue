            ...
            <section class="col-md-4 contact" style="background-color:#f7e1f3;">
                <div class="border-1 border-black mx-5 p-2" style="border-radius: 5px;background-color: white;">
                    ...
                    <form action="" method="post" class="contact-form px-3">
                        <div class="mb-3">
                            <input type="text" v-model="form.name" name="name" placeholder="Enter your name" required
                                maxlength="20" class="box">
                        </div>
                        <div class="mb-3">
                            <input type="email" v-model="form.email" name="email" placeholder="Enter your email"
                        ...
                        <div class="mb-3">
                            <textarea name="msg" v-model="form.message" class="box" placeholder="Enter your message"
