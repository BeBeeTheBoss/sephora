<template>
    ...
    <div class="container row py-4">
        ...
        >
            <Product
                @click="openProductModal(index, product.id)"
                :name="product.name"
                ...
                <div class="text-center pa-4">
                    <v-dialog v-model="dialogArray[index]" width="auto">
                        ...
                        >
                            ...
                            <div>
                                <Carousel
                                    :from="'productCarousel' + product.id"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p
                                            class="card-text text-muted whitespace-pre-wrap"
                                            style="font-size: 10px"
                                        >
                                            {{ product.description }}
                                        </p>
                                        <div
                                            class="fw-bold d-flex align-items-center justify-between"
                                            style="color: #fe919d"
                                        >
                                            <div>
                                                {{ product.price }}Ks
                            ...
                            style="font-size:12px">{{ product.discount_price }}</span> -->
                                    ...
                                    <div class="flex items-center">
                                        <div
                                            class="col-5 flex justify-center items-center mt-3"
                                        >
                                            <IconBtn
