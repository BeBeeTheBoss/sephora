                            ...
                            <v-card max-width="600" class="pb-3" style="position: relative; min-height: 500px">
                                ...
                                ">
                                    <font-awesome-icon @click="dialogArray[index] = false" icon="fa-solid fa-xmark"
                                        class="me-2 text-white fs-5" style="
                                ...
                                <div>
                                    ...
                                    <div class="" style="position: relative; cursor: pointer">
                                        <div class="card-body px-3 pt-3" style="
                                            max-height: 150px;
                                            overflow-y: auto;
                                        ">
                                            <div class="flex justify-between items-center">
                                                <span class="text-muted" style="font-size: 12px">{{
                                                    ...
                                                    <font-awesome-icon class="ms-2 me-1" icon="fa-solid fa-fire" style="
                                                        font-size: 13px;
                                                        color: #fe919d;
                                                    " />{{ product.view_count }}</span>
                                                <IconBtn v-if="product.is_favorite" @click="
                                                    addToWishlist(product.id)
                                                    " icon="fa-solid fa-heart" style="
                                                    ...
                                                    color: #fe919d;
                                                " />
                                                <IconBtn v-else @click="
                                                    addToWishlist(product.id)
                                                    " icon="fa-regular fa-heart" style="
                                                    background-color: rgba(
                                                        255,
                                                        255,
                                                        255,
                            ...
                            style="font-size:12px">{{ product.discount_price }}</span> -->
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="pt-3 col-7 pe-3">
                                                <button class="btn w-100 fw-bold" @click="
                                                    addToCart(
                                                        index,
                                                        product.id,
                                                        quantity[index]
...
const all_products = ref(props.new_arrival_products);
