<template>
    <Layout>
        <Link href="/admin/products/create"><button class="btn btn-sm mb-3 float-end" style="border: 1px solid #ff006e">
            + Create New
        </button></Link>
        <div class="row">
                ...
                <div class="card card-body">
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <span class="text-danger" style="font-size:14px;">{{ product.discount_price }}% Off</span>
                        </div>
